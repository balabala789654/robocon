...
void CAN2_RX1_IRQHandler(void)
{
	...
	{
		case lifting_motor1_id: get_motor_measure(&rabbit.clamping.lifting_motor[0].feedback, Rx2Message);break;
		case door_motor1_id: get_motor_measure(&rabbit.clamping.door_motor[0].feedback, Rx2Message);break;
		case door_motor2_id: get_motor_measure(&rabbit.clamping.door_motor[1].feedback, Rx2Message);break;
		case lifting_motor2_id: get_motor_measure(&rabbit.clamping.lifting_motor[1].feedback, Rx2Message);break;
		case pitch_motor_id: get_motor_measure(&rabbit.clamping.pitch_motor.feedback, Rx2Message);break;
	}
